...
import { notFound, useRouter } from 'next/navigation'; // useRouter might be needed if edit/delete directly navigate
...
export default function ItemDetailClient({ params }: ItemDetailClientProps) {
